...
const App = () => {
  ...
  function buildDeepLinkFromNotificationData(data) {
    ...
    if (!isAuthenticated) {
      ...
      if (navigationId === 'HomeDetails') {
        navigationRef.current?.navigate(navigationId, { chatId: data.chatId})
  ...
  const linking = {
    ...
    async getInitialURL() {
      ...
      if (isAuthenticated && initialDeepLink != null) {
        navigationRef.current?.navigate(message.data.navigationId, { chatId: message.data.chatId })
        setInitialDeepLink(null)
    ...
    subscribe(listener) {
      ...
      const unsubscribe = messaging().onNotificationOpenedApp(remoteMessage => {
        ...
        if (isAuthenticated && initialDeepLink != null) {
          navigationRef.current?.navigate(remoteMessage.data.navigationId, { chatId: remoteMessage.data.chatId})
          setInitialDeepLink(null)
  ...
  useEffect(() => {
    ...
    if (isAuthenticated && initialDeepLink != null) {
      navigationRef.current?.navigate(notifcationData.data.navigationId, { chatId: notifcationData.data.chatId })
      setInitialDeepLink(null)
